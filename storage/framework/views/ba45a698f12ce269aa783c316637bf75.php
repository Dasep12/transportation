...
<?php $__env->slot('title'); ?> Reportes Order Payment <?php $__env->endSlot(); ?>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <div class="input-group" id="datepicker2">
                                <input readonly type="text" required class="form-control" placeholder="yyyy-mm-dd" value="<?php echo e(date('Y-m-d')); ?>" name="date_first" id="date_first" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            <label for="">Fecha Inicial : *</label>
                            <div class="input-group" id="datepicker2">
                                <input readonly type="text" required class="form-control" placeholder="yyyy-mm-dd" value="<?php echo e(date('Y-m-d')); ?>" name="date_end" id="date_end" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/reportes/index.blade.php ENDPATH**/ ?>