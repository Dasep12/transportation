                ...
                for (let i = 0; i < e.length; i++) {
                    ...
                    <div class="col-sm-5">
                        <div class="mt-4 mt-md-0">
                            <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/gallery/${ e[i].filename }')); ?>" title="">
                                <img class="img-fluid" alt="" src="<?php echo e(asset('public/gallery/${ e[i].filename }')); ?>" width="145">
                            </a>
                        </div>
                    </div>
                    </td>`;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/cars/gallery.blade.php ENDPATH**/ ?>