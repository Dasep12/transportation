            ...
            <div class="bg-primary-subtle">
                <div class="row">
                    ...
                    <div class="col-5 align-self-end">
                        <img src="<?php echo e(asset('public/build/images/profile-img.png')); ?>" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="<?php echo e(asset('public/images/user.png ')); ?>" alt="" class="img-thumbnail rounded-circle">
                        </div>
                        <h5 class="font-size-15 text-truncate"><?php echo e(strtoupper(Session('username'))); ?></h5>
                    </div>
                    ...
                    <div class="col-sm-8">
                        <div class="pt-4">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="font-size-15"><?php echo e($driver); ?></h5>
                                    <p class="text-muted mb-0">Drivers</p>
                                </div>
                                <div class="col-6">
                                    <h5 class="font-size-15"><?php echo e($cust); ?></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/dashboard/dashboard.blade.php ENDPATH**/ ?>