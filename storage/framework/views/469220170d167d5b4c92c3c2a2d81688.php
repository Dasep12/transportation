                ...
                <div class="card-body">
                    ...
                    <div class="col-xl-9">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="user_type_id" class="form-control" id="">
                                    ...
                                    <option value="<?php echo e($ty->id); ?>"><?php echo e($ty->user_type); ?></option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" required value="<?php echo e(old('username')); ?>" name="username" required class="form-control" id="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/administrator/form_add.blade.php ENDPATH**/ ?>