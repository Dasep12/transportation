             ...
             <ul class="metismenu list-unstyled" id="side-menu">
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         ...
                         <li class="<?= AuthHelper::isUriFirs() == 'solicitud' ? 'mm-active' : '' ?>">
                             <a href="/solicitud" key="t-exchange">Solicitud</a>
                         </li>
                         ...
                         <li class="<?= AuthHelper::isUriFirs() == 'tourismroute' ? 'mm-active' : '' ?>">
                             <a href="/tourismroute" key="t-ico">Ruta Turismo</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul class="sub-menu" aria-expanded="false">
                         <li><a href="/prevedor" key="t-inbox">Preveedor</a></li>
                         <li><a href="/empresas" key="t-read-email">Empresas</a></li>
                         <li><a href="/orden" key="t-read-email">Orden de Pago</a></li>
                         <li><a href="/concepto" key="t-read-email">Concepto de Pago</a></li>
                         <li><a href="email-read.html" key="t-read-email">Reportes</a></li>
                     </ul>
                 </li>
 ...
 <!-- Left Sidebar End --><?php /**PATH D:\Projects\wwwroot\Admin\cores\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>