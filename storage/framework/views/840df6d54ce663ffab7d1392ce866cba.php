    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" action="/concepto/updated" novalidate>
                    <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input hidden type="text" name="id" id="id" value="<?php echo e($data->id); ?>">
                                <input type="text" value="<?php echo e($data->concept); ?>" name="concept" required class="form-control" id="validationTooltip01">
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/concepto/form_edit.blade.php ENDPATH**/ ?>