...
<body>
    <div class="row">
        <div class="column">
            <table class="border-all">
                ...
                <tbody>
                    <tr>
                        <td colspan="2"><?php echo e(strtoupper($data[0]->suppliers)); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($data[0]->idprevedor); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="column2">
            <table class="border-all" style="margin-left: 10px;">
                ...
                <tbody>
                    <tr>
                        <td><b>Empresa</td>
                        <td><?php echo e(strtoupper($data[0]->company)); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><b>Fecha</b></td>
                        <td><?php echo e($data[0]->dates); ?></td>
                    </tr>
                    <tr>
                        <td><b>Condiciones. Pago</b></td>
                        <td><?php echo e($data[0]->terms); ?></td>
                    </tr>
                    <tr>
                        <td><b>Forma de Pago</b></td>
                        <td><?php echo e($data[0]->statues); ?></td>
                    </tr>
                    <tr>
                        <td><b>Solicitante</b></td>
                        <td><?php echo e($data[0]->aplicant); ?></td>
                    </tr>
                    <tr>
    ...
    <?php if($data[0]->approved == 'En proceso'): ?>
    ...
    <div class="row3" style="margin-top: 80px !important;text-align:center">
        <div class="column">
            ...
            <label for=""><?php echo e($data[0]->aplicant); ?></label>
        </div>
        <div class="column2">
...
</html><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/ordenpago/reportpdf.blade.php ENDPATH**/ ?>