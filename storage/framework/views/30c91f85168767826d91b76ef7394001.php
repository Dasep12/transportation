                    ...
                    <div class="col-xl-9 mt-4">
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                ...
                                <input type="text" autocomplete="off" value="<?php echo e(old('caseta_name')); ?>" name="caseta_name" required class="form-control" id="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/casetasroutes/form_add.blade.php ENDPATH**/ ?>