...
<?php $__env->slot('title'); ?> Cotizaciones <?php $__env->endSlot(); ?>
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        <td><a class='image-popup-vertical-fit' href="<?php echo e(asset('public/admin/img/payment')); ?>/${data[i].payment_proof } " title="Caption. Can be aligned it to any side and contain any HTML.">
                                        <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/payment')); ?>/${data[i].payment_proof } " width="145">
                                    </a></td>
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        html += `<tr>
                        <td>${ number++ }</td>
                        <td><a target="_blank" href='<?php echo e(asset('public/invoice')); ?>/${ data[i].name_invoice }'>${ data[i].name_invoice }</a></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/quotes/listmaster.blade.php ENDPATH**/ ?>