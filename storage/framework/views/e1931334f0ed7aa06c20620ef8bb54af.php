                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group" id="datepicker2">
                                        <input value="<?php echo e(old('purchase_date')); ?>" type="text" required class="form-control" placeholder="yyyy-mm-dd" name="purchase_date" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/cars/form_add.blade.php ENDPATH**/ ?>