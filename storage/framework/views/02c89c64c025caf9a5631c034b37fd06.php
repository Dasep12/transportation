        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="needs-validation" method="post" novalidate enctype="multipart/form-data" action="/drivers/services/adedd">
                    <?php echo csrf_field(); ?>
                    <input type="text" hidden name="service_id" value="<?php echo e($servid); ?>" id="service_id">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="needs-validation" novalidate>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" required name="init_odometer" value="<?php echo e($initial_service != null ? "$initial_service->init_odometer" : ''); ?>" class="form-control number-decimal" id="init_odometer">
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-check form-check-success mb-3">
                                                        <input <?php if(!empty($initial_service)): ?> <?php echo e($initial_service->others_fuel == 'no' ?   'checked' : ''); ?> <?php endif; ?> class="checkbox form-check-input" type="checkbox" id="">
                                                        <label class="form-check-label" for="">
                                                            Tanque Lleno
                                                        </label>
                                                        <input readonly class="form-control" <?php if(!empty($initial_service)): ?> <?php echo e($initial_service->others_fuel == 'no' ?   'name="initial_fuel_tank" ' : ''); ?> <?php endif; ?> placeholder="fuel tank" value="<?php echo e($fuel_tank); ?>" type="text" id="fuel_1">
                                                    </div>
                                                    <div class="form-check form-check-success mb-3">
                                                        <input <?php if(!empty($initial_service)): ?> <?php echo e($initial_service->others_fuel == 'yes' ?   'checked' : ''); ?> <?php endif; ?> placeholder="fuelCheck" value="1" class="form-check-input checkbox" type="checkbox" id="fuelCheck">
                                                        <label class="form-check-label" for="fuelCheck">
                                                            Otro :
                                                        </label>
                                                        <input type="text" placeholder="type_fuel" name="type_fuel" hidden <?php if(!empty($initial_service)): ?> value='<?php echo e($initial_service->others_fuel); ?>' <?php endif; ?> id="type_fuel">
                                                        <input name="" type="text" placeholder="fuel others" <?php if(!empty($initial_service) && $initial_service->others_fuel == 'yes'): ?> name='initial_fuel_tank' value='<?php echo e($initial_service->initial_fuel_tank); ?>' <?php endif; ?> class="form-control number-decimal" id="fuel_2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="mt-2 col-sm-3">
                                                    <?php if(!empty($initial_service)): ?>
                                                    <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/services/'. $initial_service->evidencia)); ?>" title="">
                                                        <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/services/'. $initial_service->evidencia)); ?>" width="40">
                                                    </a>
                                                    <?php endif; ?>
                                        ...
                                        <div class="form_section_fuel_recharge">
                                            <div class="">
                                                ...
                                                if (count($service_intermediate) > 0) { ?>
                                                    <?php $__currentLoopData = $service_intermediate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div>
                                                        <div class="row mb-3">
                                                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Odometro al cargar : * </label>
                                                            <div class="col-sm-3">
                                                                <input value="<?php echo e($si->id); ?>" type="text" hidden name="idIntermediate[]" id="id">
                                                                <input value="<?php echo e($si->odometer_time_charge); ?>" type="text" name="odometer_time_charge[]" class="form-control number-decimal" id="validationTooltip01">
                                                            </div>
                                                            <div class="valid-tooltip">
                                                                Looks good!
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input value="<?php echo e($si->amount_liters_charged); ?>" type="text" name="amount_liters_charged[]" class="form-control number-decimal" id="validationTooltip01">
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Costo Total : * </label>
                                                            <div class="col-sm-3">
                                                                <input value="<?php echo e($si->cost_charged_fuel); ?>" type="text" name="cost_charged_fuel[]" class="form-control number-decimal" id="validationTooltip01">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/services/'. $si->photo_evidence)); ?>" title="">
                                                                <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/services/'. $si->photo_evidence)); ?>" width="40">
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <hr>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="field_section_destination" id="field_section_destination">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" hidden value="<?php if(!empty($service_destination)): ?> <?php echo e($service_destination->id); ?> <?php endif; ?>" name="idDestination" id="">
                                                    <input <?php if(!empty($service_destination)): ?> value='<?php echo e($service_destination->odometer_at_destination); ?>' <?php endif; ?> type="text" name="odometer_at_destination" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Nivel de Combustible al Llegar : * </label>
                                                <div class="col-sm-3">
                                                    <input <?php if(!empty($service_destination)): ?> value='<?php echo e($service_destination->fuel_tank_at_destination); ?>' <?php endif; ?> type="text" name="fuel_tank_at_destination" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Foto Evidencia : * </label>
                                                ...
                                                <?php if(!empty($service_destination)): ?>
                                                <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/services/'. $service_destination->photo_destination)); ?>" title="">
                                                    <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/services/'. $service_destination->photo_destination)); ?>" width="40">
                                                </a>
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="">
                                            ...
                                            if (count($returning_destination) > 0) { ?>
                                                <?php $__currentLoopData = $returning_destination; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <div class="row mb-3">
                                                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Odometro al cargar : * </label>
                                                        <div class="col-sm-3">
                                                            <input type="text" value="<?php echo e($rd->id); ?>" hidden name="idreturning1[]">
                                                            <input value="<?php echo e($rd->return_odometer_time_charge); ?>" type="text" name="return_odometer_time_charge[]" class="form-control number-decimal" id="validationTooltip01">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Litros Cargados : * </label>
                                                        <div class="col-sm-3">
                                                            <input value="<?php echo e($rd->return_amount_liters_charged); ?>" type="text" name="return_amount_liters_charged[]" class="form-control number-decimal" id="validationTooltip01">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Costo Total de Combustible : * </label>
                                                        <div class="col-sm-3">
                                                            <input value="<?php echo e($rd->return_cost_charged_fuel); ?>" type="text" name="return_cost_charged_fuel[]" class="form-control number-decimal" id="validationTooltip01">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="horizontal-email-input" class="col-sm-3 col-form-label">Foto Evidencia : * </label>
                                                        ...
                                                        <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/services/'. $rd->return_photo_evidence)); ?>" title="">
                                                            <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/services/'. $rd->return_photo_evidence)); ?>" width="40">
                                                        </a>
                                                    </div>
                                                </div>
                                                <hr>
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div id="section_return_to_home" class="section_return_to_home">
                                            <div class="row mb-3">
                                                ...
                                                <input hidden type="text" <?php if(!empty($home_service)): ?> value='<?php echo e($home_service->id); ?>' <?php endif; ?> name="id_home">
                                                <div class="col-sm-3">
                                                    <input type="text" <?php if(!empty($home_service)): ?> value='<?php echo e($home_service->home_odometer_arrival); ?>' <?php endif; ?> name="home_odometer_arrival" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Nivel de Combustible en Encierro: * </label>
                                                <div class="col-sm-3">
                                                    <input <?php if(!empty($home_service)): ?> value='<?php echo e($home_service->home_fuel_level_arrival); ?>' <?php endif; ?> type="text" name="home_fuel_level_arrival" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Litros Cargados para llenar el tanque:* </label>
                                                <div class="col-sm-3">
                                                    <input <?php if(!empty($home_service)): ?> value='<?php echo e($home_service->home_charge_fill_tank); ?>' <?php endif; ?> type="text" name="home_charge_fill_tank" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Costo Total de Recarga : * </label>
                                                <div class="col-sm-3">
                                                    <input <?php if(!empty($home_service)): ?> value='<?php echo e($home_service->home_cost_fuel_fill_tank); ?>' <?php endif; ?> type="text" name="home_cost_fuel_fill_tank" class="form-control number-decimal" id="validationTooltip01">
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <label for="horizontal-email-input" class="col-sm-3 col-form-label">Foto Evidencia : * </label>
                                                ...
                                                <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/services/'. $home_service->home_photo_evidence)); ?>" title="">
                                                    <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/services/'. $home_service->home_photo_evidence)); ?>" width="40">
                                                </a>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.layouts_drivers.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/drivers/form_edit.blade.php ENDPATH**/ ?>