...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="needs-validation" enctype="multipart/form-data" method="post" action="/adminuser/updated" novalidate>
            <?php echo csrf_field(); ?>
            <input type="text" name="id" hidden id="id" value="<?php echo e($data->id); ?>">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-3">
                                <div class="mt-4 mt-md-0">
                                    <a class="image-popup-vertical-fit" href="<?php echo e(asset('public/admin/img/driver/'. $data->photo )); ?>" title="">
                                        <img class="img-fluid" alt="" src="<?php echo e(asset('public/admin/img/driver/'. $data->photo )); ?>" width="145">
                                    </a>
                                </div>
                            </div>
                            <div class="valid-tooltip">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo e($data->address); ?>" name="address" required class="form-control" id="validationTooltip01">
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="col-xl-9">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="user_type_id" class="form-control" id="">
                                    ...
                                    <option <?php echo e($data->user_type_id == $ty->id ? 'selected' : ''); ?> value="<?php echo e($ty->id); ?>"><?php echo e($ty->user_type); ?></option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" required value="<?php echo e($data->username); ?>" name="username" required class="form-control" id="">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\wwwroot\Admin\resources\views/admin/administrator/form_edit.blade.php ENDPATH**/ ?>