...
<!-- form repeater js -->
<script src="{{ URL::asset('public/build/libs/jquery.repeater/jquery.repeater.min.js') }}"></script>

<script src="{{ URL::asset('public/build/js/pages/form-repeater.int.js') }}"></script>
