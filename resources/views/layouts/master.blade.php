...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ URL::asset('public/build/images/mx.png') }}">
    ...
    <!-- Chart JS -->
    <script src="{{ URL::asset('public/build/libs/chart.js/chart.umd.js') }}"></script>
    <script src="{{ URL::asset('public/build/js/pages/chartjs.init.js') }}"></script>
