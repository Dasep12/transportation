                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group" id="datepicker2">
                                            <input readonly value="{{ old('departure_date')}}" type="text" required class="form-control" placeholder="yyyy-mm-dd" name="departure_date" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group" id="timepicker-input-group1">
                                            <input readonly id="timepicker" name="departure_time" type="text" value="{{ old('departure_time')}}" required class="form-control" data-provide="timepicker">
