...
@slot('title') Cost Per Services @endslot
@endcomponent
                        ...
                        <table id="datatableCos" class="table align-middle  table-bordered  mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ucwords(strtolower($d->customer_name)) }}</td>
                                    <td>{{ ucwords(strtolower($d->route_name)) }}</td>
                                    <td>{{ $d->departure_date . ' ' . $d->departure_time }}</td>
                                    <td>{{ $d->returning_date . ' ' . $d->returning_time }}</td>
                                    <td>{{ $d->no_of_days }}</td>
                                    <td>{{ ucwords(strtolower($d->first_name)) }}</td>
                                    ...
                                    <td>
                                        <a href="/costperservice/edited?id={{ $d->id }}"><i class="fas fa-edit font-size-16 text-success"></i></a>
                                        <a href="/costperservice/details?id={{ $d->id }}"><i class="fas fa-eye font-size-16 text-secondary"></i></a>
                                        <a onclick="return confirm('Sure Delete ?')" href="/costperservice/delete?id={{ $d->id }}"><i class="fas fa-trash font-size-16 text-danger"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
