                ...
                <form method="post" enctype="multipart/form-data" action="/casetas_route/updated" class="needs-validation" novalidate>
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $data->caseta_name }}" name="caseta_name" required class="form-control" id="">
                                @error('caseta_name')
                                        ...
                                        <?php foreach ($cars_categ as $cos) : ?>
                                            ...
                                            <tr id="R<?= $rowIdx++ ?>">
                                                <td>
                                                    <select name="category_cars[]" class="form-control select2">
                                                        <?php foreach ($category as $c) : ?>
                                                            <option {{ $c->id == $cos->cars_category ? 'selected' : '' }} value="{{ $c->id }}"><?= ucwords(strtolower($c->name)) ?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="image-popup-vertical-fit" href="{{ asset('public/admin/img/casetas/'. $cos->images ) }}" title="">
                                                        <img class="img-fluid" alt="" src="{{ asset('public/admin/img/casetas/'. $cos->images ) }}" width="145">
                                                    </a>
                                                </td>
                                                <td>
