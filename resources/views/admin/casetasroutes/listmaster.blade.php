...
@slot('title') Casetas Route @endslot
@endcomponent
<?php
                        ...
                        <table id="datatableUser" class="table align-middle  table-bordered  mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ucwords(strtolower($d->caseta_name))}}</td>

                                    <td>
                                        @php($l = 0 )
                                        @php($k = count(models::getCategoriesCars($d->id) ) )
                                        @foreach(models::getCategoriesCars($d->id) as $c)
                                        {{ ucwords(strtolower($c->name))  }}
                                    ...
                                    <td>
                                        <a href="/casetas_route/edited?id={{ $d->id }}"><i class="font-size-14 text-success fas fa-edit"></i></a>

                                        <a href="/casetas_route/delete?id={{ $d->id }}" onclick="return confirm('Sure delete ?')"><i class="font-size-14 text-danger fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
