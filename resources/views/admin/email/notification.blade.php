...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('public/css_pdf/style_notif.css') }}">
</head>
...
<body>
    ...
    <div class="container-custom">
        ...
        <div class="row">
            ...
            <input type="text" hidden name="idxQuotes" value="{{ $_GET['q'] }}" id="idxQuotes">
            <div class="col-lg-8">
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><b>$ {{ number_format($amount,2) }}</b></p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success btn-block" data-dismiss="modal">OK</button>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnIdx").click(function() {
                ...
                //     }
                // })
                window.location.href = '/payment_form?idQuotes={{ $_GET["q"] }}';
            })
        })
