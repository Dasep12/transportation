...
<body>
                    ...
                    <div class="card top-0 mb-3">
                        <div class="card-body">
                            <div class="comment-text-sm ">
                                ...
                                <p><b class="mb-4"> Estimado (a) {{ $mailData['res']['customer_name'] }}</b></p>
    ...
    <label for="">
        <i>If you have trouble to read this email content, please try with WEB VERSION: <a href="https://solomon.mundochiapas.com/notifEmail?q={{ base64_encode($mailData['res']['id']) }}">https://solomon.mundochiapas.com/notifEmail?q={{ base64_encode($mailData['res']['id']) }} </a> </i>
    </label>
