                        ...
                        <table id="datatable2" class="table align-middle  table-bordered  mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $dt->status }}</td>
                                    <td>
                                        <a href="/costumers/edited?id={{ $dt->id }}"><i class="font-size-14 text-success fas fa-edit"></i></a>

                                        <a onclick="return confirm('Change Status ?')" href="/costumers/changeStatus?stat={{ $dt->status }}&id={{ $dt->id }}"><i class="font-size-14 text-primary fas <?= $dt->status == 'Active' ? 'fa-check ' : 'fa-minus-circle '  ?>"></i></a>

                                        <a href="/costumers/delete?id={{ $dt->id }}" onclick="return confirm('Sure delete ?')"><i class="font-size-14 text-danger fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
