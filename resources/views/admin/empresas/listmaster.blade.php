                        ...
                        <table id="datatable" class="table align-middle  table-bordered  mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/empresas/edited?id={{ $d->id }}"><i class="font-size-14 text-success fas fa-edit"></i></a>


                                        <a href="/empresas/delete?id={{ $d->id }}" onclick="return confirm('Sure delete ?')"><i class="font-size-14 text-danger fas fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
