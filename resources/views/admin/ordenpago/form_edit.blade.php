            ...
            <div class="card-body">
                ...
                <form method="post" class="needs-validation" action="/ordendepago/updated" novalidate>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <select name="supplier_id" required id="supplier_id" class="form-control select5">
                                ...
                                <option {{ $data->supplier_id == $pre->id ? 'selected' : '' }} value="{{ $pre->id }}">{{ ucwords(strtolower($pre->name)) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="company_id" required id="company_id" class="form-control select3">
                                ...
                                <option {{ $data->company_id == $pr->id ? 'selected' : '' }} value="{{ $pr->id }}">{{ ucwords(strtolower($pr->name)) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="applicant_id" required id="applicant_id" class="form-control select2">
                                ...
                                <option {{ $data->applicant_id == $pr->id ? 'selected' : '' }} value="{{ $pr->id }}">{{ ucwords(strtolower($pr->first_name .' ' .  $pr->last_name)) }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row  mt-3 mb-3">
                        <div class="col-lg-4">
                            ...
                            <select name="concept_id" required id="concept_id" class="form-control select4">
                                ...
                                <option {{ $data->concept_id == $pc->id ? 'selected' : '' }} value="{{ $pc->id }}">{{ ucwords(strtolower($pc->concept)) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="type_id" id="type_id" class="form-control select2">
                                ...
                                <option {{ $data->type_id == $pm->id ? 'selected' : '' }} value="{{ $pm->id }}">{{ ucwords(strtolower($pm->description)) }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="input-group" id="datepicker2">
                                <input value="{{ $data->date }}" readonly type="text" required class="form-control" placeholder="yyyy-mm-dd" id="datepickerr" name="date" data-date-format="yyyy-mm-dd" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
                    ...
                    <div class="row  mt-3 mb-3">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group">
                                <input type="text" value="{{ $data->terms }}" required class="form-control" name="terms" id="terms">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <label for="horizontal-email-input" class=" col-form-label">
                            ...
                            <div class="form-group">
                                <select name="cost_id" id="cost_id" class="form-control select2">
                                    <option value="">-SELECCIONER-</option>
                                    @foreach($cost as $cs)
                                    <option {{ $data->cost_id == $cs->id ? 'selected' : '' }} value="{{ $cs->id }}">{{ ucwords(strtolower($cs->departure_city .'-' . $cs->destination_city)) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-12">
                            <table class="table table-bordered">
                                ...
                                <tbody id="tbody">
                                    ...
                                    <tr id="">
                                        <td style="width:60%">
                                            <input value="{{ $dtl->description }}" class="form-control" type="text" name="description[]" required id="">
                                        </td>
                                        <td>
                                            <input value="{{ $dtl->quantity }}" class="form-control number-decimal" type="text" name="count[]" required id="">
                                        </td>
                                        <td>
                                            <input class="form-control number-decimal" value="{{ $dtl->unit_price }}" type="text" name="price_u[]" required id="">
                                        </td>
                                        <td>
                    ...
                    <div class="mt-2">
                        ...
                        <a href="/ordendepago/resendMail?id={{ $data->id }}" class="btn btn-info waves-effect waves-light">
