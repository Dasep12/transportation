            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align: right;">
                        <p style="color:#e7e6e6;font-size:10px !important"><strong>Folio: {{ explode("-",$data->invoice_number)[1] }}</strong></p>
                    </th>
                </tr>
            </thead>
        </table>
        ...
        <table style="width: 100%;border-collapse: collapse;margin-top:50px">
            ...
            <tbody>
                ...
                <tr style="font-size: small;">
                    ...
                    <td style="padding: 0 4px;height: 20px; line-height:25px;">
                        {{ number_format(($i->price * $i->qty)  * $i->tax,2) }}
                    </td>
                ...
                <tr>
                    <td colspan="5" style="padding-top: 20px; padding-bottom: 15px; border-top: 1px dashed #333; border-bottom: 1px dashed #333;">
                        <table style="vertical-align: middle; padding-top: 15px; padding-bottom: 15px; width: 100%;border-collapse: collapse;">
                            ...
                            <tbody>
                                <tr style="font-size: small;">
                                    <td style="font-size:small;line-height: 15px; text-align: left;">Responsable: <strong> {{ Session('username') }}</strong>
                                    </td>
