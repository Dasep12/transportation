                ...
                <tr>
                    <td>
                        <table>
                            <tbody>
                                <tr>
                                    <td><a href="#"><img width="200px" src="{{ asset('public/admin/img/logo/logo-mundochiapas.png') }}"></a></td>
                                ...
                                <tr>
                                    <td colspan="5" style="padding-top: 10px; padding-bottom: 10px; border-top: 2px dashed #333; border-bottom: 2px dashed #333;">
                                        <table style="vertical-align: middle; padding-top: 10px; padding-bottom: 10px; width: 100%;border-collapse: collapse;">
                                            <tbody>
                                                <tr>
                                                    <td style="line-height: 20px; text-align: left;">Responsable: <strong>{{ ucwords(strtolower(Session('fullname'))) }}</strong>
                                                    </td>
                                                    <td>
                                                        <table style="width: 100%; border-collapse: collapse;">
                                                            <tbody>
