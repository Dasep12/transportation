                ...
                <form class="needs-validation" method="post" action="/services/updated" novalidate>
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="itinerary" required>{{ $data->itinerary }}</textarea>
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="driver" id="driver" class="form-control select2">
                                    ...
                                    @foreach($driver as $d)
                                    <option {{ $data->driver_id == $d->id ? 'selected' : '' }} value="{{ $d->id }}">{{ ucwords(strtolower($d->first_name)) .' ' . ucwords(strtolower($d->last_name))  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="valid-tooltip">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group" id="datepicker2">
                                    <input readonly type="text" required class="form-control" placeholder="yyyy-mm-dd" id="datepickerr" name="date" data-date-format="yyyy-mm-dd" value="{{ $data->date }}" data-date-container='#datepicker2' data-provide="datepicker" data-date-autoclose="true">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group" id="timepicker-input-group1">
                                    <input readonly id="timepicker" name="time_departure" type="text" value="{{ $data->time_departure }}" required class="form-control" data-provide="timepicker">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="cars" id="cars" class="form-control select2">
                                    ...
                                    @foreach($car as $c)
                                    <option {{ $data->car_id == $c->id ? 'selected' : '' }} value="{{ $c->id }}">{{ ucwords(strtolower($c->car_name))  }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="valid-tooltip">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="meeting_point" value="{{ $data->meeting_point }}" required class="form-control" id="meeting_point">
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $data->departure }}" name="departure" required class="form-control" id="departure">
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="{{ $data->destination }}" name="destination" required class="form-control" id="destination">
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="expenses" value="{{ $data->expenses }}" required class="form-control" id="expenses">
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="status_" id="status_" class="form-control">
                                    ...
                                    <option {{ $data->status == 'In Progress' ? 'selected' : '' }} value="In Progress">In Progress</option>
                                    <option {{ $data->status == 'Accomplished' ? 'selected' : '' }} value="Accomplished">Accomplished</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="status_payment" id="status_payment" class="form-control">
                                    <option {{ $data->status == 'In Progress' ? 'selected' : '' }} value="Pending">Pending</option>
                                    <option {{ $data->status == 'Paid' ? 'selected' : '' }} value="Paid">Paid</option>
                                </select>
                            </div>
                            <div class="valid-tooltip">
                                Looks good!
