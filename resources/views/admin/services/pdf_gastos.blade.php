...
<body>
        ...
        <div class="column" style="width: 50% !important;">
            <table class="" align="left">
                <tr>
                    ...
                    <td class="left_title"><span style="margin-left: 10px;">{{ $headerData[0]->cliente }}</span></td>
                </tr>
                <tr>
                    <td class="right_title"><b>Ruta:</b></td>
                    <td class="left_title"> <span>{{ $headerData[0]->ruta }}</span> </td>
                </tr>
                <tr>
                    <td class="right_title"><b>Inicio de servicio:</b></td>
                    <td class="left_title"><span>{{ $headerData[0]->inicio_de_servicio }} </span></td>
                </tr>
                <tr>
                    <td class="right_title"><b>Fin de Servicio: </b></td>
                    <td class="left_title"><span> {{ $headerData[0]->fin_de_servicio }} </span></td>
                </tr>
            </table>
        </div>
        <div class="column2">
            <table class="">
                <tr>
                    ...
                    <td class="left_title"><span>{{ $headerData[0]->no_operados }}</span></td>
                </tr>
                <tr>
                    <td class="right_title"><b>Operador:</b></td>
                    <td class="left_title"> <span>{{ $headerData[0]->operador }}</span></td>
                </tr>
                <tr>
                    <td class="right_title"><b>Unidad:</b></td>
                    <td class="left_title"><span>{{ $headerData[0]->unidad }}</span></td>
                </tr>
                <tr>
                    <td class="right_title"><b>No. Días: </b></td>
                    <td class="left_title"><span>{{ $headerData[0]->no_dias }}</span> </td>
                </tr>
            </table>
        </div>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr style="text-align: center;">
                    ...
                    <td>
                        {{ $presupuesto->total_travel_kms }} Km
                    </td>
                    <td>
                        {{ ServicePDFModel::IDAKilometros_por_recorrer($serviceId) }} Kms
                    </td>
                    <td>
                        {{ ServicePDFModel::RegresoKilometros_por_recorrer($serviceId) }} Kms
                    </td>
                    <?php
                    ...
                    <td>
                        ...
                        ?>
                        <img style="width: 20px ;" src="{{  asset('public/images/'. $ratekilometres)  }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    ...
                    <td>
                        {{ number_format(($presupuesto->total_liter_consume - $totalesLitros) / $presupuesto->total_liter_consume * 100,2) }} %
                    </td>
                    <td>
                        <?php
                        $ratelitros  = $differenlitros < 0 ? 'like.png' : 'dislike.png';
                        ?>
                        <img style="width: 20px ;" src="{{ asset('public/images/'. $ratelitros) }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    <td style="text-align: right !important;">
                    ...
                    <td>
                        <b>$
                            {{ number_format($presupuesto->total_liter_consume * $presupuesto->cost_per_liter,2) }}
                        </b>
                    </td>
                    <td>
                        $ {{ ServicePDFModel::IDACostodeCombustible($serviceId) }}
                    </td>
                    <td>
                        $ {{ ServicePDFModel::RegresoCostodeCombustible($serviceId)  }}
                    </td>
                    <td>
                        <b>
                            <?php
                            $totalescosto = ServicePDFModel::IDACostodeCombustible($serviceId) +  ServicePDFModel::RegresoCostodeCombustible($serviceId)  ?>
                            $ {{ number_format($totalescosto,2) }}
                        </b>
                    </td>
                    <td>
                        <?php
                        ...
                        ?>
                        $ {{ number_format($diffrecosto,2) }}
                    </td>
                    <td>
                        {{ number_format($diffrecosto / ($presupuesto->total_liter_consume * $presupuesto->cost_per_liter) * 100 ,2) }} %
                    </td>
                    <td>
                        <img style="width: 20px ;" src="{{ asset('public/images/like.png') }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    <td style="text-align: right !important;">
                    ...
                    <td>
                        <b>$ {{ number_format($presupuesto->total_casetas  ,2) }} </b>
                    </td>
                    <td>
                        $ {{ number_format($presupuesto->total_casetas / 2 ,2) }}
                    </td>
                    <td>
                        $ {{ number_format($presupuesto->total_casetas / 2 ,2) }}
                    </td>
                ...
                <tr style="text-align: center;">
                    ...
                    <td>
                        <b>$ {{ number_format($presupuesto->total_fee_drivers,2)}}</b>
                    </td>
                    <td>
                        $ {{ number_format(ServicePDFModel::HonorariosOperadores($serviceId)->results_1,2) }}
                    </td>
                    <td>
                        $ {{ number_format(ServicePDFModel::HonorariosOperadores($serviceId)->results_3,2) }}
                    </td>
                    <td>
                        <b>
                            $ {{ number_format(ServicePDFModel::HonorariosOperadores($serviceId)->results_1 +  ServicePDFModel::HonorariosOperadores($serviceId)->results_3 ,2) }}
                        </b>
                    </td>
                    <td> $ 0.0</td>
                    <td>-</td>
                ...
                <tr style="text-align: center;">
                    ...
                    <td>
                        <b>$ {{ number_format($presupuesto->hotel_fee,2)}} </b>
                    </td>
                    <td colspan="2">
                        $ {{ number_format(ServicePDFModel::othersPayment($serviceId)['hospedaje'],2) }}
                    </td>
                    <td>
                        <b>
                            $ {{ number_format(ServicePDFModel::othersPayment($serviceId)['hospedaje'],2) }}
                    ...
                    <td>
                        ...
                        <img style="width: 20px ;" src="{{ asset('public/images/'.  $rateHotel) }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    <td style="text-align: right !important;">
                    ...
                    <td>
                        <b>$ {{ number_format($presupuesto->car_wash,2)}} </b>
                    </td>
                    <td colspan="2">
                        $ {{ number_format(ServicePDFModel::othersPayment($serviceId)['lavado'],2) }}
                    </td>
                    <td>
                        <b>$ {{ number_format(ServicePDFModel::othersPayment($serviceId)['lavado'],2) }} </b>
                    </td>
                    <td>
                        <?php $difLavado =  ServicePDFModel::othersPayment($serviceId)['lavado'] - $presupuesto->car_wash ?>
                        ${{ number_format($difLavado,2) }}
                    </td>
                    <td>
                        <?php
                    ...
                    <td>
                        ...
                        <img style="width: 20px ;" src="{{ asset('public/images/'.$ratelavado) }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    <td style="text-align: right !important;">
                    ...
                    <td>
                        <b>$ {{number_format($presupuesto->airport_fee ,2) }} </b>
                    </td>
                    <td colspan="2">
                        $ {{ number_format(ServicePDFModel::othersPayment($serviceId)['airport'],2) }}
                    </td>
                    <td>
                        <b>$ {{ number_format(ServicePDFModel::othersPayment($serviceId)['airport'],2) }}</b>
                    </td>
                    <td>
                        <?php
                        $difeaero = ServicePDFModel::othersPayment($serviceId)['airport'] - $presupuesto->airport_fee;
                        ?>
                        {{ '$ '.number_format($difeaero ,2)  }}
                    </td>
                    <td>
                        <?php
                    ...
                    <td>
                        ...
                        <img style="width: 20px ;" src="{{ asset('public/images/'. $rateaero) }}" alt="">
                    </td>
                </tr>
                <tr style="text-align: center;">
                    <td style="text-align: right !important;">
                    ...
                    <td><b>$0.00</b></td>
                    <td colspan="2">
                        $ {{ number_format(ServicePDFModel::othersPayment($serviceId)['others'],2) }}
                    </td>
                    <td>
                        <b>$ {{ ServicePDFModel::othersPayment($serviceId)['others'] }}</b>
                    </td>
                    <td>$ {{ ServicePDFModel::othersPayment($serviceId)['others'] > 0 ? '-' . ServicePDFModel::othersPayment($serviceId)['others'] : ServicePDFModel::othersPayment($serviceId)['others']  }}</td>
                    <td>-</td>
                    <td>
                        <img style="width: 20px ;" src="{{ asset('public/images/like.png') }}" alt="">
                    </td>
                ...
                <tr style="text-align: center;background:#ddd">
                    ...
                    <td>
                        <b>
                            ...
                            $operadocountreg = ServicePDFModel::HonorariosOperadores($serviceId)->results_3;
    ...
    <div class="row4">
        <b>Resumen del Viaje: </b>{{ $totaleskilometers }} kms recorridos
    </div>

    <div class="row5" style="margin-top: 10px;">
        <div class="column"> <b>Odómetro Inicial: </b> {{ count($initialServices) != null ? $initialServices[0]->init_odometer : 0  }} </div>
        <div class="column"> <b>Odómetro en Destino: </b> {{ count($Destination) != null ? $Destination[0]->odometer_at_destination : 0  }}</div>
        <div class="column"> <b>Odómetro Final: </b> {{ count($ReturningToHome) != null ? $ReturningToHome[0]->home_odometer_arrival : 0  }}</div>
    </div>
    <hr style="border-color:black;background:black">
    ...
    <div class="row6">
        <table>
            <tr>
                ...
                <td>
                    <b>
                        @if($totaleskilometers > 0 ||$totalesLitros > 0)
                        {{ number_format( $totaleskilometers /  $totalesLitros ,2) }} kms / litro
                        @else
                        0 kms / litro
                        @endif
                    </b>
            ...
            <tr>
                ...
                <td>
                    <b>
                        @if($totaleskilometers > 0 ||$totalesLitros > 0)
                        {{ number_format(100 / ($totaleskilometers / $totalesLitros) ,2) }} lts / 100 kms
                        @else
                        0 kms / litro
                        @endif
                    </b>
    ...
    <div class="row7" style="margin-top: 10px;">
        ...
        ?>
        <span style="margin-top: 10px ;">Detalles de Casetas: {{ count($detailCasets) }} casetas | $ {{ number_format($casetascountida,2) }} x 2 </span>
        <table>
            @php($keys = 0 )
            <td>@foreach($detailCasets as $DS) {{ $DS->caseta_name }}: $ {{ $DS->costo_casetas }} @if($keys > 0 && $keys < count($detailCasets) ) | @endif @endforeach</td>
        </table>
    </div>

    <div class="row8" style="margin-top: 10px;">
        <span style="margin-top: 10px ;">Comentarios Operador:</span>
        <textarea style="width: 100%;height:100px">{{ $note }}</textarea>
    </div>
