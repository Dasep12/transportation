    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td style="width: 30%" class="text-center"><img width="200px" src="{{ asset('public/front/image007.jpeg') }}"></td>
                <td style="width: 30%" class="text-center"><img width="200px" src="{{ asset('public/front/image005.jpeg') }}"></td>
            </tr>
        </tbody>
    </table>
    <br />
