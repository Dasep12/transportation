        ...
        <tbody>
            ...
            <tr>
                <td class="text-justify">
                    ...
                    <b>TERCERA</b>.- El costo del servicio <b>{{ '$ ' .number_format($contractPage1[0]->total_amount,2) }}</b> incluye lo siguiente: <b>Combustible</b> de la unidad para los traslados especificados en el Itinerario del anexo 1, <b>Peajes</b>
