        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                for (let i = 0; i < e.length; i++) {
                    html += `<tr>`;
                    html += `<td><a class="image-popup-vertical-fit" href="{{ asset('public/admin/service_file/${ e[i].filename }') }}" title="">
                                <img class="img-fluid" alt="" src="{{ asset('public/admin/service_file/${ e[i].filename }') }}" width="145">
                            </a></td>`;
